...
int main() {
	...
	std::string vertexShaderSource = JSLib::loadShaderSourceFromFile("assets/vertexShader.vert");
	std::string fragmentShaderSource = JSLib::loadShaderSourceFromFile("assets/fragmentShader.frag");
